...
=======
                <input className='reg_input' type = 'password' name = 'password' placeholder = 'Password' value = {this.state.password} onChange = {this.handleInputChange} />
>>>>>>> cc1f586e3609a74340443dcc9849aea270ffffc6
