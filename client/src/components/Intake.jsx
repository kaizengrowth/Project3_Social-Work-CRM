          ...
          <h1>Resources</h1>
            <div className = 'int_form_container'>
              <form className = 'int_form' onSubmit = {(e => this.submitEditForm(e, this.state))} >
                ...
                <input className = 'intake_input' type = 'text' name = 'studentexpectations' placeholder = 'What are your expectations?' value = {this.state.studentexpectations} onchange = {this.handleInputChange} /><br/>
